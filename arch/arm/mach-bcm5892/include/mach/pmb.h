...
typedef enum pmb_mbox_ids {
	...
	SCL_TEST_ID,
	SCL_KEK_DES_ENCRYPT_ID,
	SCL_KEK_DES_DECRYPT_ID,
	SCL_GET_REAL_RANDOM_ID,
	SCL_SET_NOT_SECURITY_RUN_ID,
	SCL_ALLOW_NOT_SECURITY_RUN_ID,
	SCL_LOAD_PLAIN_DES_KEY_ID,
	SCL_LOAD_MISC_DES_KEY_ID,
	SCL_KEY_DES_ENCRYPT_ID,
	SCL_KEY_DES_DECRYPT_ID,
	SCL_RTC_SETTIME_ID,
	SCL_RTC_GETTIME_ID,
